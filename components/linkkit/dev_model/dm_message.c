...
int dm_msg_send_msg_timeout_to_user(int msg_id, int devid, iotx_dm_event_types_t type)
{
    ...
    amp_snprintf(message, message_len, DM_MSG_SEND_MSG_TIMEOUT_FMT, msg_id, IOTX_DM_ERR_CODE_TIMEOUT, devid);
                    ...
                    _IN_ char *data, _IN_ int data_len, _IN_ void *user_data)
{
    ...
    memset(payload, 0, payload_len);
    amp_snprintf(payload, payload_len, DM_MSG_RESPONSE_WITH_DATA,
                                ...
                                _IN_ char *payload, _IN_ int payload_len)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_THING_MODEL_DOWN_FMT, devid, strlen(hexstr), hexstr);
    DM_free(hexstr);
...
int dm_msg_property_set(int devid, dm_msg_request_payload_t *request)
{
    ...
    memset(message, 0, message_len);
#ifdef LOG_REPORT_TO_CLOUD
    amp_snprintf(message, message_len, DM_MSG_PROPERTY_SET_FMT, devid, request->params.value_length, request->params.value,
                 request->id.value_length, request->id.value);
#else
    amp_snprintf(message, message_len, DM_MSG_PROPERTY_SET_FMT, devid, request->params.value_length, request->params.value);
#endif
...
int dm_msg_property_get(_IN_ int devid, _IN_ dm_msg_request_payload_t *request, _IN_ void *ctx)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_THING_PROPERTY_GET_FMT, request->id.value_length, request->id.value, devid,
                                 ...
                                 char *identifier, int identifier_len, dm_msg_request_payload_t *request,  _IN_ void *ctx)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_SERVICE_REQUEST_FMT, request->id.value_length, request->id.value, devid,
                        ...
                        char *rrpcid, int rrpcid_len, dm_msg_request_payload_t *request)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_RRPC_REQUEST_FMT, request->id.value_length, request->id.value, devid,
...
int dm_msg_thing_event_property_post_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_PROPERTY_POST_REPLY_FMT, id, response->code.value_int, devid,
                 payload_len, payload);
    DM_free(str_payload);
                                  ...
                                  _IN_ dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_SPECIFIC_POST_REPLY_FMT, id, response->code.value_int, devid,
...
int dm_msg_thing_property_desired_get_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_PROPERTY_DESIRED_GET_REPLY_FMT, id, response->code.value_int,
                 response->data.value_length, response->data.value);
...
int dm_msg_thing_property_desired_delete_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_PROPERTY_DESIRED_DELETE_REPLY_FMT, id, response->code.value_int,
...
int dm_msg_thing_deviceinfo_update_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_DEVICEINFO_UPDATE_REPLY_FMT, id, response->code.value_int, devid);
...
int dm_msg_thing_deviceinfo_delete_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_DEVICEINFO_DELETE_REPLY_FMT, id, response->code.value_int, devid);
...
int dm_msg_ntp_response(char *payload, int payload_len)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_THING_NTP_RESPONSE_FMT, lite_item_server_send_time.value_length,
...
int dm_msg_topo_add_notify(_IN_ char *payload, _IN_ int payload_len)
{
    ...
    for (index = 0; index < lite.size; index++) {
        ...
        memset(message, 0, message_len);
        amp_snprintf(message, message_len, DM_MSG_TOPO_ADD_NOTIFY_USER_PAYLOAD, res, devid, product_key, device_name);
                         ...
                         _IN_ char device_name[IOTX_DEVICE_NAME_LEN + 1])
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_THING_DISABLE_FMT, devid);
                        ...
                        _IN_ char device_name[IOTX_DEVICE_NAME_LEN + 1])
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_THING_ENABLE_FMT, devid);
                        ...
                        _IN_ char device_name[IOTX_DEVICE_NAME_LEN + 1])
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_THING_DELETE_FMT, res, product_key, device_name, devid);
...
int dm_msg_thing_sub_register_reply(dm_msg_response_payload_t *response)
{
    ...
    if (response->code.value_int != IOTX_DM_ERR_CODE_SUCCESS) {
        ...
        memset(message, 0, message_len);
        amp_snprintf(message, message_len, DM_MSG_EVENT_SUBDEV_REGISTER_REPLY_FMT, atoi(temp_id), response->code.value_int, 0);
    ...
    for (index = 0; index < lite.size; index++) {
        ...
        memset(message, 0, message_len);
        amp_snprintf(message, message_len, DM_MSG_EVENT_SUBDEV_REGISTER_REPLY_FMT, atoi(temp_id), response->code.value_int,
                     devid);
...
static void dm_msg_thing_proxy_product_register_reply_successes(dm_msg_response_payload_t *response, lite_cjson_t *lite)
{
    ...
    for (index; index < lite->size; index++) {
        ...
        memset(message, 0, message_len);
        amp_snprintf(message, message_len, DM_MSG_EVENT_PROXY_PRODUCT_REGISTER_REPLY_FMT, atoi(temp_id),
                     response->code.value_int,
                     devid);
...
int dm_msg_thing_sub_unregister_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_SUBDEV_UNREGISTER_REPLY_FMT, id, response->code.value_int, devid);
...
int dm_msg_thing_topo_add_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_THING_TOPO_ADD_REPLY_FMT, id, response->code.value_int, devid);
...
int dm_msg_thing_topo_delete_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_THING_TOPO_DELETE_REPLY_FMT, id, response->code.value_int, devid);
...
int dm_msg_topo_get_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_TOPO_GET_REPLY_FMT, id, response->code.value_int, IOTX_DM_LOCAL_NODE_DEVID,
                 response->data.value_length,
                 response->data.value);
...
int dm_msg_combine_login_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_COMBINE_LOGIN_REPLY_FMT, atoi(temp_id), response->code.value_int,
                 devid);
...
int dm_msg_combine_logout_reply(dm_msg_response_payload_t *response)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_EVENT_COMBINE_LOGOUT_REPLY_FMT, atoi(temp_id), response->code.value_int,
                 devid);
                                        ...
                                        _IN_ char device_name[IOTX_DEVICE_NAME_LEN + 1], _OU_ dm_msg_request_t *request)
{
    ...
    /* Random */
    amp_snprintf(random, DM_UTILS_UINT64_STRLEN, "%llu", (unsigned long long)amp_uptime());
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_THING_PROXY_PRODUCT_REGISTER_PARAMS, product_key, device_name,
                                ...
                                _OU_ dm_msg_request_t *request)
{
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_THING_SUB_UNREGISTER_PARAMS, product_key, device_name);
                          ...
                          _IN_ char device_secret[IOTX_DEVICE_SECRET_LEN + 1], _OU_ dm_msg_request_t *request)
{
    ...
    /* TimeStamp */
    amp_snprintf(timestamp, DM_UTILS_UINT64_STRLEN, "%llu", (unsigned long long)amp_uptime());

    /* Client ID */
    amp_snprintf(client_id, IOTX_PRODUCT_KEY_LEN + 1 + IOTX_DEVICE_NAME_LEN + 1 + 1, "%s.%s", product_key, device_name);
    ...
    memset(sign_source, 0, sign_source_len);
    amp_snprintf(sign_source, sign_source_len, DM_MSG_THING_TOPO_ADD_SIGN_SOURCE, client_id,
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_THING_TOPO_ADD_PARAMS, product_key, device_name,
                             ...
                             _OU_ dm_msg_request_t *request)
{
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_THING_TOPO_DELETE_PARAMS, product_key, device_name);
                            ...
                            _OU_ dm_msg_request_t *request)
{
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_THING_LIST_FOUND_PARAMS, product_key, device_name);
                         ...
                         _IN_ char device_secret[IOTX_DEVICE_SECRET_LEN + 1], _OU_ dm_msg_request_t *request)
{
    ...
    /* Client ID */
    amp_snprintf(client_id, IOTX_PRODUCT_KEY_LEN + 1 + IOTX_DEVICE_NAME_LEN + 25,
    ...
    memset(sign_source, 0, sign_source_len);
    amp_snprintf(sign_source, sign_source_len, DM_MSG_COMBINE_LOGIN_SIGN_SOURCE, client_id,
                 device_name, product_key, timestamp);
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_COMBINE_LOGIN_PARAMS, product_key, device_name,
                          ...
                          _OU_ dm_msg_request_t *request)
{
    ...
    memset(params, 0, params_len);
    amp_snprintf(params, params_len, DM_MSG_COMBINE_LOGOUT_PARAMS, product_key, device_name);
...
int dm_msg_property_set(int devid, dm_msg_request_payload_t *request)
{
    ...
    for (index = 0; index < lite.size; index++) {
        ...
        memset(message, 0, message_len);
        amp_snprintf(message, message_len, DM_MSG_PROPERTY_SET_FMT, devid, lite_item_key.value_length, lite_item_key.value);
                                 ...
                                 char *identifier, int identifier_len, dm_msg_request_payload_t *request,  _IN_ void *ctx)
{
    ...
    memset(message, 0, message_len);
    amp_snprintf(message, message_len, DM_MSG_SERVICE_REQUEST_FMT, id, devid, identifier_len, identifier,
                 request->params.value_length, request->params.value);
#else
