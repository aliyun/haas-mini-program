...
// 			wifi_info.signal, wifi_info.ssid ? wifi_info.ssid : "TPLink");
...
// 	for (i = 0; i < scaned_info.count; i++) {
// 		wifi_info = &scaned_info.macs[i];
// 		if (i == 0) {
