 ...
 */
extern void *amp_realloc(void *ptr, unsigned int size);
extern void *amp_malloc(unsigned int size);
extern void amp_free(void *ptr);

#if !defined(DUK_ANSI_MALLOC)
#define DUK_ANSI_MALLOC      amp_malloc
#endif

#if !defined(DUK_ANSI_REALLOC)
#define DUK_ANSI_REALLOC     amp_realloc
#endif
#if !defined(DUK_ANSI_CALLOC)
// #define DUK_ANSI_CALLOC      duk_custom_calloc
#endif
#if !defined(DUK_ANSI_FREE)
#define DUK_ANSI_FREE        amp_free
#endif
