...
int32_t amp_system_sleep(void)
{
    return -1;
}

int32_t amp_system_autosleep(int mode)
{
    return -1;
}

int32_t amp_wakelock_lock(void *wakelock)
{
    return -1;
}

int32_t amp_wakelock_unlock(void *wakelock)
{
    return -1;
}

int32_t amp_wakelock_timedlock(void *wakelock, unsigned int msec)
{
    return -1;
}
