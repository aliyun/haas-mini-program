...
uintptr_t amp_tcp_establish(_IN_ const char *host, _IN_ uint16_t port)
{
...
int32_t amp_tcp_destroy(uintptr_t fd)
{
    int rc;
...
int32_t amp_tcp_write(uintptr_t fd, const char *buf, uint32_t len,
                      uint32_t timeout_ms)
{
    int      ret, err_code;
    uint32_t len_sent;
