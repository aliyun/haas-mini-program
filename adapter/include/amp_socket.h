 ...
 *          On error, -1 is returned, and errno is set appropriately.
 */
int amp_socket_sendto(int sockfd, const void *data, size_t size, int flags, const struct sockaddr *to, socklen_t tolen);
 ...
 * @return  the number of bytes received, or -1 if an error occurred.
 */
int amp_socket_recvfrom(int socket, void *data, size_t len, int flags, struct sockaddr *from, socklen_t *fromlen);
 ...
 *          On error, -1 is returned, and errno is set appropriately.
 */
int amp_socket_connect(int sockfd, const struct sockaddr *addr, socklen_t addrlen);
 ...
 *          On error, -1 is returned, and errno is set appropriately.
 */
int amp_socket_select(int maxfdp1, fd_set *readset, fd_set *writeset, fd_set *exceptset, struct timeval *timeout);
 ...
 *          On error, -1 is returned, and errno is set appropriately.
 */
int amp_socket_shutdown(int socket, int how);
