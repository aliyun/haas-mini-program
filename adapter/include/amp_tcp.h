 ...
 */
int amp_tcp_establish(const char *host, unsigned int port);
 ...
 * @return  0: success, otherwise: fail.
 */
int amp_tcp_destroy(unsigned int fd);
 ...
 * @return  0: success, otherwise: fail.
 */
int amp_tcp_write(unsigned int fd, const char *buf, unsigned int len, unsigned int timeout_ms);
 ...
 * @return  0: success, otherwise: fail.
 */
int amp_tcp_read(unsigned int fd, char *buf, unsigned int len, unsigned int timeout_ms);
